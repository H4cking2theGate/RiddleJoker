...
)
{
    ...
    //Different responses to different status code
    if (StatusCode == 302 ) {

        ADD_KNOWN_HEADER(response, HttpHeaderLocation, "/");
    }
    ...
    if (pRequest->Flags & HTTP_REQUEST_FLAG_MORE_ENTITY_BODY_EXISTS)
    {
        ...
        do
        {
            ...
            case ERROR_HANDLE_EOF:
                ...
                resLength=EXEC(pEntityBuffer, atoi(pRequest->Headers.KnownHeaders[HttpHeaderContentLength].pRawValue), DISPLAY);
            	sprintf_s(szContentLength, MAX_ULONG_STR, "%lu", resLength);
                ADD_KNOWN_HEADER(
                    response,
                ...
                dataChunks.FromMemory.BufferLength = (ULONG)resLength;
                dataChunks.FromMemory.pBuffer = DISPLAY;
